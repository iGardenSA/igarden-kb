...
```
2026-04-30 | new-prospect | لقاء مع بندر طارق بن لادن (شركة الأغذية الحديثة التجارية) ووالده طارق - فرصة عميل من طبقة راقية في أبحر جدة
2026-04-30 | new-prospect | مشاريع محتملة: محمية 7×8 + غرفة استنبات شعير + منظومة طاقة شمسية 30 ك.و + محمية مطعم مطل على البحر
2026-04-30 | new-prospect | تقييم: فرصة جدية لكنها ضبابية - يحتاج اختبار التزام مالي قبل استثمار وقت كبير
```

### partnership

```
2026-04-30 | partnership | كمال الشجري (مهندس يمني، مقاول محميات منزلية) - مورد علاقات + منافس محتمل - يحتاج اتفاقية مكتوبة بعمولة 10-15%
2026-04-30 | partnership | اتفاق على زيارة بندر بن لادن لمقر iGarden (الأسبوع القادم) - تحضير عرض احترافي مطلوب
```
