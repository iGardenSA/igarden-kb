...
> ⚠️ **تاريخ تفعيل الشراكة المستهدف كان 2026-04-01** — اليوم 2026-04-30، أي أن الشراكة فُعِّلت (أو يفترض أنها فُعِّلت) منذ ~30 يوماً وهذه البنود لم تُغلق بعد. أي تأخير إضافي يعرّض الشركة لمخالفات نظامية + مشاكل توثيق دخول الشركاء.
